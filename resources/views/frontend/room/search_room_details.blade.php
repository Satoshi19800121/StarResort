            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input autocomplete="off" type="text" required name="check_in" id="check_in" class="form-control dt_picker" value="{{old('check_in') ? date('Y-m-d',strtotime(old('check_in') )):""}}" placeholder="yyyy-mm-dd">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input autocomplete="off" type="text" required name="check_out" id="check_out" class="form-control dt_picker" value="{{old('check_out') ? date('Y-m-d',strtotime(old('check_out') )):""}}" placeholder="yyyy-mm-dd">
                            <span class="input-group-addon"></span>
                        </div>
                        <i class='bx bxs-calendar'></i>
                    </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-7 col-md-8 p-0">
                                    <div class="room-card-content">
                                        ...
                                        <ul>
                                            <li><i class='bx bx-show-alt'></i> {{$item->view}} Balcony</li>
