                                ...
                                <div class="card-body">
                                      <div class="billing-details">
                                            ...
                                            <table class="table" style="width: 100%">
                                                @php
                                                $subtotal = $room->price * $nights * $book_date['number_of_rooms'];
                                                ...
                                                @endphp
                                                  ...
                                                  <tr>
                                                        <td><p>Total Night <br> <b> ( {{ $book_date['check_in']}}-{{ $book_date['check_out']}})</p></td>
                                                        <td style="text-align: right"><p>{{$nights}} Days</p></b></td>
                                                  </tr>
                                                  <tr>
                                                        <td><p>Total Room</p></td>
                                                        <td style="text-align: right"><p>{{ $book_date['number_of_rooms']}}</p></td>
                                                  </tr>
                                                  <tr>
                                                        <td><p>Subtotal</p></td>
