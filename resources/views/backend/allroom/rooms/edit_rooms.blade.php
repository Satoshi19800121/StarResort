						...
						<div class="card">
							<div class="card-body p-4">
								...
								<form class="row g-3" action="{{ route('update.room',$editData->id) }}" method="post" enctype="multipart/form-data">
									...
									<div class="col-md-4">
										<label for="input2" class="form-label">Tolal Adult</label>
										<input type="text" name="total_adult" class="form-control" id="input2" value="{{ $editData->total_adult }}">
									</div>
									<div class="col-md-4">
										<label for="input2" class="form-label">Tolal Child</label>
									...
									<div class="col-md-6">
										...
										<img id="showImage" src="{{ (!empty($editData->image)) ? url('upload/rooming/'.$editData->image) : url('upload/no_image.jpg')}}" alt="Admin" class="bg-primary" width="70" height="50">
									</div>
									...
									<div class="col-md-6">
										...
										<img src="{{ (!empty($item->multi_img)) ? url('upload/rooming/multi_img/'.$item->multi_img) : url('upload/no_image.jpg') }}" alt="Admin" class="bg-primary" width="60"> 
									...
									<div class="col-md-3">
										<label for="input2" class="form-label">Discout ( ％ )</label>
									...
									<div class="col-md-12">
										...
										<textarea name="description" class="form-control" id="myeditorinstance" placeholder="Address ..." rows="3">{!! $editData->description !!}</textarea>
									</div>
                  ...
                  <br>
					...
					<!--//End promaryhome-->
									...
									<div class="tab-pane fade" id="primaryprofile" role="tabpanel">
										<div class="card"></div>
											<div class="card-body">
												<a class="card-title btn btn-primary float-right" onClick="addRoomNo()" id="addRoomnNo">
									...
									<div class="roomnoHide" id="roomnoHide">
										...
										<div class="row">
											...
											<div class="col-md-4">
												...
												<button type="submit" class="btn btn-success" style="margin-top:28px;">Save</bottn>
											</div>
										</div>
										</form>	
									</div>
